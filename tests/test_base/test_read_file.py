...
def test_read_sync_bytes(temp_bytes_file: tuple[Path, bytes]):
...
def test_read_sync_str(temp_text_file: tuple[Path, str]):
    from file_utils import read_file_sync
...
async def test_read_async_bytes(temp_bytes_file: tuple[Path, bytes]):
...
async def test_read_async_str(temp_text_file: tuple[Path, str]):
...
def test_read_bytes_1(temp_bytes_file: tuple[Path, bytes]):
...
async def test_read_bytes_2(temp_bytes_file: tuple[Path, bytes]):
    from file_utils import read_file
...
def test_read_str_1(temp_text_file: tuple[Path, str]):
    from file_utils import read_file
...
async def test_read_str_2(temp_text_file: tuple[Path, str]):
    from file_utils import read_file
